...
angular.module('copayApp.controllers').controller('recoveryFromSeed',
	function ($rootScope, $scope, $log, $timeout, profileService, configService) {
		...
		var wallet_defined_by_keys = require('inWalletcore/wallet_defined_by_keys.js');
		var objectHash = require('inWalletcore/object_hash.js');
		try {
			var ecdsa = require('secp256k1');
		}
		catch (e) {
			var ecdsa = require('inWalletcore/node_modules/secp256k1' + '');
		}
		let Mnemonic = require('bitcore-mnemonic');
		let Bitcore = require('bitcore-lib');
		let db = require('inWalletcore/db.js');
		// var myWitnesses = require('inWalletcore/my_witnesses');
