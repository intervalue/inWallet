...
angular.module('copayApp.controllers').controller('importController',
    function ($rootScope, $scope, $timeout, storageService, notification, profileService, bwcService, $log, $stateParams, gettext, gettextCatalog, lodash, go, isCordova) {
        ...
        self.importw = function(){
            ...
            profileService.importWallets({ name: self.importname, password: self.importpass, mnemonic: self.importcode2,m:1,n:1,networkName:"livenet",cosigners:[],isSinglecreateress:true ,type: indexScope.type}, function (err,walletId) {
                $timeout(function () {
                    if (isCordova)
