var balances = require('inWalletcore/balances');
...
function initWallet() {
	...
	function loadCompleteClient(showClient) {
		self._binWalletCoreLoaded = false; //"fix" : Looks like you are loading multiple copies of inWallet core, which is not supported. Running 'npm dedupe' might help.
		...
		angularJs.onload = function() {
			var inWalletJS = document.createElement('script');
			inWalletJS.src = 'inWallet.js';
			body.appendChild(inWalletJS);
			inWalletJS.onload = function() {
